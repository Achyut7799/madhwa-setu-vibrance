...
const PanditConnect = () => {
  ...
  const [filteredPandits, setFilteredPandits] = useState(panditProfiles);
  const [searchClicked, setSearchClicked] = useState(false);

  const handleSearch = (e) => {
    e.preventDefault();
    setSearchClicked(true);
    const filtered = panditProfiles.filter((pandit) =>
      pandit.region.toLowerCase().includes(selectedRegion.toLowerCase())
    );
    ...
    <div className="py-12 md:py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="spiritual-card p-6 md:p-8 mb-8">
              ...
              <form className="space-y-6" onSubmit={handleSearch}>
                ...
                <div>
                  <label className="block text-madhwa-deep-purple mb-1">Ceremony Type</label>
                  <select className="w-full p-2 border border-madhwa-light-gray rounded-md focus:outline-none focus:ring-2 focus:ring-madhwa-purple">
                    <option>Select ceremony type</option>
                    <option>Gruhapravesham (Housewarming)</option>
                    <option>Upanayanam (Thread Ceremony)</option>
                    <option>Vivaha (Marriage)</option>
            ...
            <div className="spiritual-card p-6 md:p-8">
              ...
              <form className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-madhwa-deep-purple mb-1">Name</label>
                    <input type="text" className="w-full p-2 border border-madhwa-light-gray rounded-md" />
                  </div>
                  <div>
                    <label className="block text-madhwa-deep-purple mb-1">Email</label>
                    <input type="email" className="w-full p-2 border border-madhwa-light-gray rounded-md" />
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-madhwa-deep-purple mb-1">Date</label>
                    <input type="date" className="w-full p-2 border border-madhwa-light-gray rounded-md" />
                  </div>
                  <div>
                    <label className="block text-madhwa-deep-purple mb-1">Event</label>
                    <input type="text" className="w-full p-2 border border-madhwa-light-gray rounded-md" />
                ...
                <div>
                  <label className="block text-madhwa-deep-purple mb-1">Event Details</label>
                  <textarea className="w-full p-2 border border-madhwa-light-gray rounded-md h-24"></textarea>
                </div>
                <button type="submit" className="btn-secondary w-full">
                  Submit Request
                </button>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-madhwa-deep-purple mb-6">Available Pandits</h2>
            {searchClicked && filteredPandits.length === 0 ? (
              <div className="bg-red-100 text-red-700 p-4 rounded-md">
                No pandits available for the selected region.
              </div>
            ) : (
              <div className="space-y-6">
            ...
            <div className="mt-8 p-4 bg-madhwa-light-gray rounded-lg">
              ...
              <button className="btn-primary">Register as a Pandit</button>
            </div>
          </div>
        </div>
      </div>
